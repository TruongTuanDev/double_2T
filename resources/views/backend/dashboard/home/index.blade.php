      ...
      <div class="col-lg-3">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  ...
                  <h5>Số lượng nhà tuyển dụng</h5>
              </div>
              <div class="ibox-content">
                  <h1 class="no-margins">{{$countEmployer}}</h1>
                  <div class="stat-percent font-bold text-info"><i class="fa fa-level-up"></i></div>
                  <small>tổng số nhà tuyển dụng</small>
              </div>
          </div>
      </div>
      <div class="col-lg-3">
          <div class="ibox float-e-margins">
              ...
              <div class="ibox-content">
                  <h1 class="no-margins">{{$countStudent}}</h1>
      ...
      <div class="col-lg-3">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  ...
                  <h5>Số lượng công việc</h5>
              </div>
              <div class="ibox-content">
                  <h1 class="no-margins">{{$countPost}}</h1>
