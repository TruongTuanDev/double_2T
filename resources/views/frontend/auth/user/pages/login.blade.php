    <div class="grid login-grid main login-box">
            ...
            <div class="vnw-title">Đăng nhập để tiếp tục!
                <div class="vnw-login__social">
                    ...
                    <a href=""
                        ...
                        <span class="text-mobile">Với tài khoản Google</span>
                    </a>
                </div>
                <span class="vnw-login__sml-text">hoặc với email</span>
            </div>
        </div>
        ...
        <p class="text-center m-b-none register">Bạn chưa có mật khẩu?
            <a href="{{route('user.register')}}"><strong>Đăng ký ngay!</strong></a>
        </p>
        <hr class="hidden-xs">
