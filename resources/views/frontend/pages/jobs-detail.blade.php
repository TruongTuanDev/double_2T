                  ...
                  <div class="card jobs-card">
                      <div class="card-body ">
                          <div class="view_job_item  d-flex align-items-center justify-content-start">
                              ...
                              <div class="job-info mx-2">
                                  <div class="job-name job-item">
                                      <a href="{{route('companydetail',$company->id_emp)}}" class="job-link">{{$company->name_compn}}</a>
                                  </div>
                                  <div class="job-salary job-item">{{$company->address}} | {{$job_company->address}}</div>
                                  <div class="job-location">{{$company->job_quantity}} việc làm</div>
