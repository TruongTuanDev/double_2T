<section class="section-career-advice mb-4">
  <div class="career-advice-container">
      <div class="container-fluid p-2 p-sm-3 p-lg-5">
          <h4 class="mb-3" style="font-weight: 700; color: #333;">{{ trans('hello.news')}}</h4>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card career-card" style="height: 100%;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{route('news.detail',$new->slug)}}" style="text-align: right; display: block;" class="text-black">{{ trans('hello.more')}}</a>
                    </div>
                </div>
            </div>
              @endforeach
